...
public class GoodServiceImplTest {
    ...
    public void getAllGoodsForBuyerTest() {
        ...
        when(goodDAO.getAll()).thenReturn(goods);
    ...
    public void getAllGoodsForAdminTest() {
        ...
        when(goodDAO.getAllBySearch("default",
                "")).thenReturn(goods);
        ...
        verify(goodDAO, times(1)).getAllBySearch("default", "");
    }
    ...
    public void getAllGoodsForAdminSearchedByTitleContainsLetterBAndSortedByIdInDescOrderTest() {
        ...
        when(goodDAO.getAllBySearch("title",
                "b")).thenReturn(goods);
        ...
        verify(goodDAO, times(1)).getAllBySearch("title", "b");
    }
    ...
    public void saveNewGoodTest() {
        ...
        verify(goodDAO, times(1)).save(goodConverter.fromGoodAdminCreationDto(goodDto));
    ...
    public void getGoodByIdTest_ThenReturnGood() {
        ...
        when(goodDAO.getById(id)).thenReturn(good);
        ...
        verify(goodDAO, times(1)).getById(id);
    }
    ...
    public void updateGoodTest() {
        ...
        verify(goodDAO, times(1)).update(goodConverter.fromGoodAdminCreationDto(goodDto));
        verify(userDAO, times(1)).getByLogin(user.getEmail());
    }
    ...
    public void givenGoodId_whenDeleteGood_thenNothing() {
        ...
        willDoNothing().given(goodDAO).deleteById(goodId);

        goodService.deleteById(goodId, user.getEmail());

        verify(goodDAO, times(1)).deleteById(goodId);
        verify(userDAO, times(1)).getByLogin(user.getEmail());
    }
